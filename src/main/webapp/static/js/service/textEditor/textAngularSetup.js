    ...
    .factory('taToolFunctions', ['$window','taTranslations', function($window, taTranslations) {
        return {
            imgOnSelectAction: function(event, $element, editorScope){
                ...
                var fullButton = angular.element('<button type="button" class="md-button" unselectable="on" tabindex="-1">100% </button>');
                ...
                var halfButton = angular.element('<button type="button" class="md-button" unselectable="on" tabindex="-1">50% </button>');
                ...
                var quartButton = angular.element('<button type="button" class="md-button" unselectable="on" tabindex="-1">25% </button>');
                ...
                var resetButton = angular.element('<button type="button" class="md-button" unselectable="on" tabindex="-1">Reset</button>');
                ...
                var floatLeft = angular.element('<button type="button" class="md-button" unselectable="on" tabindex="-1"><i class="material-icons">format_align_left</i></button>');
