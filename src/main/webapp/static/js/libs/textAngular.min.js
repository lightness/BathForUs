...
textAngular.directive("textAngular", ["$compile", "$window", "$document", "$rootScope", "$timeout", "taFixChrome", function (t, e, n, a, l, i) {
    ...
    a.textAngularTools = o({
        html: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/xml.svg'></md-icon></button>",
            action: function () {
                var t, e = this;
        ...
        h1: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-header-1.svg'></md-icon></button>",
            action: function () {
        ...
        h2: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-header-2.svg'></md-icon></button>",
            action: function () {
        ...
        h3: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-header-3.svg'></md-icon></button>",
            action: function () {
        ...
        p: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-paragraph.svg'></md-icon></button>",
            action: function () {
        ...
        ul: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-list-bulleted.svg'></md-icon></button>",
            action: function () {
        ...
        ol: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-list-numbers.svg'></md-icon></button>",
            action: function () {
        ...
        quote: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-quote.svg'></md-icon></button>",
            action: function () {
        ...
        undo: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/undo.svg'></md-icon></button>",
            action: function () {
                return this.$parent.wrapSelection("undo", null)
            }
        },
        redo: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/redo.svg'></md-icon></button>",
            action: function () {
                return this.$parent.wrapSelection("redo", null)
            }
        },
        bold: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-bold.svg'></md-icon></button>",
            action: function () {
        ...
        justifyLeft: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-align-left.svg'></md-icon></button>",
            action: function () {
        ...
        justifyRight: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-align-right.svg'></md-icon></button>",
            action: function () {
        ...
        justifyCenter: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-align-center.svg'></md-icon></button>",
            action: function () {
        ...
        italics: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-italic.svg'></md-icon></button>",
            action: function () {
        ...
        underline: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-underline.svg'></md-icon></button>",
            action: function () {
        ...
        clear: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/format-clear.svg'></md-icon></button>",
            action: function () {
                return this.$parent.wrapSelection("removeFormat", null)
            }
        },
        insertImage: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/tooltip-image.svg'></md-icon></button>",
            action: function () {
                var t;
        ...
        insertLink: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/link-variant.svg'></md-icon></button>",
            action: function () {
                var t;
        ...
        unlink: {
            display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><md-icon md-svg-icon='static/img/svg/link-variant-off.svg'></md-icon></button>",
            action: function () {
        ...
        require: "ngModel", scope: {}, restrict: "EA", link: function (e, o, s, r) {
            ...
            angular.extend(e, a.textAngularOpts, {
                wrapSelection: function (t, n) {
                    ...
                    if (e.showHtml)e.displayElements.html[0].focus(); else e.displayElements.text[0].focus();
            ...
            e.displayElements = {
                ...
                text: angular.element("<div contentEditable='true' ng-hide='showHtml' ta-bind='text' ng-model='text' style='border: 1px solid black;'></div>")
            };
    ...
    return {
        require: "ngModel", scope: {taBind: "@"}, link: function (a, l, i, o) {
            ...
            o.$render = function () {
                ...
                if (e[0].activeElement !== l[0]) {
                    ...
                    } else if (s || l[0].tagName.toLowerCase() !== "textarea" && l[0].tagName.toLowerCase() !== "input")l.html(t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;")); else l.val(t)
                } else if (!s)l.val(t)
            }
        }
    }
